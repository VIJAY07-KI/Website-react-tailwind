...
//   return (
//     <footer className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-12 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
//       {/* Top Section */}
//       <div className="flex flex-col lg:flex-row justify-between gap-10 lg:items-start">
//         {/* Left - Logo + Text + Nav */}
//         <div className="flex flex-col items-start space-y-5 text-sm text-gray-700 dark:text-gray-400">
//           <img
//             src={assets.logo}
//             className="w-32 sm:w-44"
//             alt="Company Logo"
...
//               type="email"
//               placeholder="Enter your email"
//               className="flex-grow p-3 text-sm outline-none rounded-l-md border border-gray-300 dark:border-gray-500 dark:bg-gray-800"
//             />
//             <button
//               type="submit"
//               className="bg-primary text-white px-6 rounded-r-md hover:bg-blue-700"
//             >
//               Subscribe
//             </button>
//           </form>
...
//       {/* Bottom Section */}
//       <div className="mt-10 border-t border-gray-200 dark:border-gray-700 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-gray-500 dark:text-gray-400">
//         {/* Left: Copyright */}
//         <p>Copyright 2025 © GreatStack - All Rights Reserved</p>

//         {/* Right: Social Links */}
//         <div className="flex gap-4 mt-4 sm:mt-0 text-gray-600 dark:text-gray-400">
...
//       {/* Bottom Section */}
//       <div className="mt-10 border-t border-gray-200 dark:border-gray-700 pt-6 text-xs text-gray-500 dark:text-gray-400 text-center">
//         <p>Copyright 2025 © GreatStack - All Rights Reserved</p>
//       </div>
//     </footer>
//   );
